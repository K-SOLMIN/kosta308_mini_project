...
INSERT INTO equipmentdetail (equipment_id, check_delete, serial_no, status)
VALUES
    (4, 'false', 'solmin-001', '정상'),
    (4, 'false', 'solmin-002', '정상'),
    (4, 'false', 'solmin-003', '수리');

-- suji equipment 낱개 3개 (equipment_id=5)
INSERT INTO equipmentdetail (equipment_id, check_delete, serial_no, status)
VALUES
    (5, 'false', 'suji-001', '정상'),
    (5, 'false', 'suji-002', '정상'),
...
-- minjoong equipment 낱개 2개 (equipment_id=6)
INSERT INTO equipmentdetail (equipment_id, check_delete, serial_no, status)
VALUES
...
INSERT INTO reservation (period_id, user_id, facility_id, equipment_id, purpose, reservation_date, status, real_use, target_type, approved_at)
VALUES (1, 10, 6, NULL, '시현용 예약', '2026-05-13', '승인', 'false', 'FACILITY', NOW());
